...
from dataset.dataset import load_data, TaskDataset, cl_collate
...
def main(args, config):
    ...
    pred_model = TaskPred(bert_model, model_type=config.model.model_type, device=device, output_size=config.model.output_size)
