...
def create_dataset(config):
    ...
    elif 'pos_enc_wavelet' in config:
        pre_transform = WaveletPE(**config.pos_enc_wavelet)
    else:
        pre_transform = None
        
    if config.dataset_name == 'Peptides-func':
        dataset = PeptidesFunctionalDataset(config.dataset_dir, pre_transform=pre_transform)
    elif config.dataset_name == 'cycpeptmpdb':
