...
def resnet18(pretrained=False, progress=True, **kwargs: Any) -> ResNet:
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)


def resnet50(pretrained=False, progress=True, **kwargs: Any) -> ResNet:
...
def init_model(model_name="ResNet18", num_classes=2, pretrained=False):
    assert model_name in get_support_model_names(), f"{model_name} is not supported"
