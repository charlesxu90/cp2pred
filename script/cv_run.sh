...
nohup python -m graph_vit.train --config graph_vit/config_reg.yaml --output_dir results/graph_vit/cyc_cpp_reg_$i --val_split $i 2>&1 >results/graph_vit/graph_vit_reg_$i.log &
